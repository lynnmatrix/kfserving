...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubeflow/kfserving/pkg/apis/serving/v1alpha2.LightGBMSpec":            schema_pkg_apis_serving_v1alpha2_LightGBMSpec(ref),
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"nthread": {
						SchemaProps: spec.SchemaProps{
							Description: "Number of thread to be used by LightGBM",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
				...
				Properties: map[string]spec.Schema{
					...
					"lightgbm": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kubeflow/kfserving/pkg/apis/serving/v1alpha2.LightGBMSpec"),
						},
					},
					"sklearn": {
						SchemaProps: spec.SchemaProps{
