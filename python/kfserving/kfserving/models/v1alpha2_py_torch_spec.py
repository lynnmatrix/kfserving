...
class V1alpha2PyTorchSpec(object):
    ...
    def model_class_name(self):
        """Gets the model_class_name of this V1alpha2PyTorchSpec.  # noqa: E501

        Defaults PyTorch model class name to 'PyTorchModel'  # noqa: E501

        :return: The model_class_name of this V1alpha2PyTorchSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def model_class_name(self, model_class_name):
        """Sets the model_class_name of this V1alpha2PyTorchSpec.

        Defaults PyTorch model class name to 'PyTorchModel'  # noqa: E501

        :param model_class_name: The model_class_name of this V1alpha2PyTorchSpec.  # noqa: E501
        :type: str
        """
    ...
    @property
    def resources(self):
        """Gets the resources of this V1alpha2PyTorchSpec.  # noqa: E501

        Defaults to requests and limits of 1CPU, 2Gb MEM.  # noqa: E501

        :return: The resources of this V1alpha2PyTorchSpec.  # noqa: E501
    ...
    def resources(self, resources):
        """Sets the resources of this V1alpha2PyTorchSpec.

        Defaults to requests and limits of 1CPU, 2Gb MEM.  # noqa: E501

        :param resources: The resources of this V1alpha2PyTorchSpec.  # noqa: E501
    ...
    def runtime_version(self):
        ...
        PyTorch KFServer docker image version which defaults to latest release  # noqa: E501
    ...
    def storage_uri(self):
        ...
        The URI of the trained model which contains model.pt  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha2PyTorchSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha2PyTorchSpec):
            return False
