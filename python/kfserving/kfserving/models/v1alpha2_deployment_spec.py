...
class V1alpha2DeploymentSpec(object):
    ...
    @property
    def logger(self):
        """Gets the logger of this V1alpha2DeploymentSpec.  # noqa: E501

        Activate request/response logging  # noqa: E501

        :return: The logger of this V1alpha2DeploymentSpec.  # noqa: E501
    ...
    def logger(self, logger):
        """Sets the logger of this V1alpha2DeploymentSpec.

        Activate request/response logging  # noqa: E501

        :param logger: The logger of this V1alpha2DeploymentSpec.  # noqa: E501
        :type: V1alpha2Logger
        """
    ...
    def max_replicas(self):
        """Gets the max_replicas of this V1alpha2DeploymentSpec.  # noqa: E501

        This is the up bound for autoscaler to scale to  # noqa: E501

        :return: The max_replicas of this V1alpha2DeploymentSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def max_replicas(self, max_replicas):
        """Sets the max_replicas of this V1alpha2DeploymentSpec.

        This is the up bound for autoscaler to scale to  # noqa: E501

        :param max_replicas: The max_replicas of this V1alpha2DeploymentSpec.  # noqa: E501
        :type: int
        """
    ...
    def service_account_name(self):
        """Gets the service_account_name of this V1alpha2DeploymentSpec.  # noqa: E501

        ServiceAccountName is the name of the ServiceAccount to use to run the service  # noqa: E501

        :return: The service_account_name of this V1alpha2DeploymentSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def service_account_name(self, service_account_name):
        """Sets the service_account_name of this V1alpha2DeploymentSpec.

        ServiceAccountName is the name of the ServiceAccount to use to run the service  # noqa: E501

        :param service_account_name: The service_account_name of this V1alpha2DeploymentSpec.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha2DeploymentSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha2DeploymentSpec):
            return False
