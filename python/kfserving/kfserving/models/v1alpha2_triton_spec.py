...
class V1alpha2TritonSpec(object):
    ...
    def __init__(self, resources=None, runtime_version=None, storage_uri=None):  # noqa: E501
        """V1alpha2TritonSpec - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def resources(self):
        """Gets the resources of this V1alpha2TritonSpec.  # noqa: E501

        Defaults to requests and limits of 1CPU, 2Gb MEM.  # noqa: E501

        :return: The resources of this V1alpha2TritonSpec.  # noqa: E501
    ...
    def resources(self, resources):
        """Sets the resources of this V1alpha2TritonSpec.

        Defaults to requests and limits of 1CPU, 2Gb MEM.  # noqa: E501

        :param resources: The resources of this V1alpha2TritonSpec.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha2TritonSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha2TritonSpec):
            return False
