...
------------ | ------------- | ------------- | -------------
**nthread** | **int** | Number of thread to be used by LightGBM | [optional] 
**resources** | [**V1ResourceRequirements**](V1ResourceRequirements.md) | Defaults to requests and limits of 1CPU, 2Gb MEM. | [optional] 
**runtime_version** | **str** | LightGBM KFServer docker image version which defaults to latest release | [optional] 
